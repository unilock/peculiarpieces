...
public class PotionPadScreen extends HandledScreen<PotionPadScreenHandler> {
    private static final Identifier TEXTURE = PeculiarPieces.id("textures/gui/single_inventory.png");
    private static final Identifier EMPTY_TEXTURE = PeculiarPieces.id("textures/gui/empty_potion.png");

    public PotionPadScreen(PotionPadScreenHandler handler, PlayerInventory inventory, Text title) {
