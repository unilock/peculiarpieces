...
public class CreativeBarrelScreen extends HandledScreen<CreativeBarrelScreenHandler> {
    private static final Identifier TEXTURE = PeculiarPieces.id("textures/gui/single_inventory.png");

    public CreativeBarrelScreen(CreativeBarrelScreenHandler handler, PlayerInventory inventory, Text title) {
