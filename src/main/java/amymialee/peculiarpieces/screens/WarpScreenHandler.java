    ...
    public WarpScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory) {
        ...
        this.addSlot(new Slot(inventory, 0, 80, 20) {
            ...
            public boolean canInsert(ItemStack stack) {
                return ((stack.isOf(PeculiarItems.POS_PEARL) || (playerInventory.player.getAbilities().creativeMode && stack.isOf(PeculiarItems.POS_PAPER))) && (stack.hasNbt() && stack.getNbt() != null && stack.getNbt().contains("pp:target")))
