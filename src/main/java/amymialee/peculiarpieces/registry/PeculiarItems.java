...
public class PeculiarItems {
    ...
    public static final Item PERPETUAL_FIGURE = registerItem("perpetual_figure", MOD_ITEMS, new EverlastingEmblemItem(new FabricItemSettings().maxCount(1).rarity(Rarity.EPIC).group(PeculiarPieces.CREATIVE_GROUP).fireproof()));
    public static final Item ETERNAL_DOUGHNUT = registerItem("eternal_doughnut", MOD_ITEMS, new EternalDoughnutItem(new FabricItemSettings().maxCount(1).rarity(Rarity.EPIC).group(PeculiarPieces.CREATIVE_GROUP).fireproof()));
