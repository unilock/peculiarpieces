...
//[una] 1.20's AbstractPressurePlateBlock sucks. Port taken from Yttr, reused here because it *also*
// broke how Peculiar Pieces uses pressure plates. All the relevant code is private now.
public abstract class AbstractLegacyPressurePlateBlock extends Block {
	...
	protected AbstractLegacyPressurePlateBlock(Settings settings) {
		super(settings);
	}
